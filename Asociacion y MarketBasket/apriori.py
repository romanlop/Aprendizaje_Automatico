...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 20:24:31 2019
...
F, soporte = apriori(dataset, min_support = 0.55, verbose = True)

H = generate_rules(F, soporte, min_confidence=0.75, verbose = True)